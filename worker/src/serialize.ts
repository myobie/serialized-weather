...
export async function* serializerAsync(node: Node | Node[], maxAwait = 1_000): AsyncGenerator<string, void, void> {
...
export async function serializeAsync(node: Node | Node[], maxAwait = 2_000) {
	let buffer = '';
